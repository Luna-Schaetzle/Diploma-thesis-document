...
\begin{itemize}
    \item \textbf{Prof. Greinöcker Albert:} Für die fachliche Betreuung, die inhaltlichen Anregungen und die stetige Motivation, die maßgeblich zur kontinuierlichen Verbesserung dieser Arbeit beigetragen haben.
    \item \textbf{Prof. Egger Eva-Maria:} Für die wirtschaftliche Betreuung und die umfassende Unterstützung bei der Erstellung der Arbeit, die uns in entscheidenden Momenten vorangebracht hat.
...
\begin{itemize}
    \item \textbf{Prof. Greinöcker Albert:} For his academic supervision, insightful suggestions, and continuous motivation, which have been crucial in the ongoing improvement of this work.
    \item \textbf{Prof. Egger Eva-Maria:} For her economic supervision and comprehensive support during the development of the thesis, which propelled us forward during critical moments.
