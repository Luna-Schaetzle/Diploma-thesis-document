...
\begin{lstlisting}[language=HTML, caption=Vue.js Template for OpenAI API Integration, frame=single]
<template>  
...
\begin{lstlisting}[language=JavaScript, caption=Vue.js Script for OpenAI API Integration, frame=single]
<script>
