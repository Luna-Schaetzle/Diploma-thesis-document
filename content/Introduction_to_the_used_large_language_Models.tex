...
To get a better overview about the collected data, we used the Python scripts to generate graphics to visualize the data.

\textbf{Quantitative Data Analysis}

To Visualize the quantitative data we used the following Python script:
...
To Visualize the qualitative data we used the following Python script:
