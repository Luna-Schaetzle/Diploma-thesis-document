\chapter{Information zur Verwendung von Künstlicher Intelligenz in dieser Arbeit / Information on the Use of Artificial Intelligence in this Work}
\label{cha:Use-of-AI}
...
\begin{itemize}
    \item \textbf{Textgenerierung:} Unterstützung bei der Formulierung, Strukturierung und stilistischen Ausarbeitung wissenschaftlicher Inhalte.
    ...
    \item \textbf{Sprachliche Optimierung:} Verbesserung der sprachlichen Qualität, Kohärenz und Verständlichkeit des Textes.
...
\begin{itemize}
    \item \textbf{Text Generation:} Assist in the formulation, structuring, and stylistic refinement of academic content.
    \item \textbf{Data Analysis:} Process and analyze large datasets to identify significant patterns and insights.
    \item \textbf{Linguistic Enhancement:} Improve the linguistic quality, coherence, and clarity of the text.
