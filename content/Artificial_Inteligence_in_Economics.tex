...
Mitigation of AI bias can be a very resource-intensive task. After identifying a bias, the model needs to be retrained. This can cost a lot of both money and time. 
