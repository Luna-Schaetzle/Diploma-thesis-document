...
\begin{longtable}{|>{\raggedright\arraybackslash}p{2cm}|>{\raggedright\arraybackslash}p{2cm}|>{\raggedright\arraybackslash}p{2cm}|>{\raggedright\arraybackslash}p{2cm}|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{4cm}|>{\raggedright\arraybackslash}p{3cm}|}
\hline
\textbf{Date} & \textbf{Start Time} & \textbf{End Time} & \textbf{Working Hours} & \textbf{Tasks} & \textbf{Details} & \textbf{Persons Involved} \\
\hline
\endhead
...
\hline
03.03.2025 & 09:20:00 & 12:00:00 & 02:40:00 & Writing & Outlook | Introduction | Small improvements & Luna \\
\hline
