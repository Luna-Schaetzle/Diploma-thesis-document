...
Further details regarding the backend implementation are provided in Chapter \ref{chap:Hosted_Flask_Service}.
...
\begin{lstlisting}[language=Vue, caption={Abbreviated Vue.js Component for the Programming Bot}, frame=single]
<template>
...
% Maby overthink the subsections    
