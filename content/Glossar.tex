...
\begin{description}[leftmargin=!,labelwidth=\widthof{\bfseries REST}]
    ...
    %\item[AI Hub] A platform that provides access to a variety of AI tools and resources, including chatbots, image recognition, and natural language processing models.
    %\item[Code Extension] An add-on for a code editor that enhances its functionality, such as providing AI-powered coding assistance.
    %\item[GitHub] A web-based platform for version control and collaboration, widely used for software development projects.
\end{description}
