...
\newcommand{\mytitle}{Integration of Artificial Intelligence} %% Titel der Arbeit
...
\input{content/thanks}                %% this is a suggestion: you have to create this file on demand
\input{content/Use-of-AI}                %% this is a suggestion: you have to create this file on demand
...
\input{content/Conceptual_Evolution_and_Rationale}
...
%\input{content/Server_Structure}


\part{Server}
%ersatz für Hardware (Maybe noch positionieren)
\input{content/Server_Hardware}
\input{content/Server_Infrastructure}

\part{Theoretical foundations} %search for a better name Maby: Software or Theoretical Part or Software background
%Software
%\input{content/used_technologies}
\input{content/Operating_Systems_used}
\input{content/used_Programming_Languages}
%\input{content/API_Libaryies}

\part{Implementation of Large Language Models}
\input{content/Introduction_to_the_used_large_language_Models}
\input{content/Hosted_Flask_Service}
\input{content/Student_AI_Hub}
\input{content/VS-code_extension}
...
%\input{content/Introduction_to_Object_Detection}
%\input{content/Implementation_of_Object_Detection}


\part{Economic analyisis of the AI market and related fields} %search for a better name
\input{content/Artificial_Inteligence_in_Economics}
\input{content/Open_source_evaluation_Economics} 
\input{content/Economic_aspekt_of_OS}

\part{Conclusion}
%\input{content/Problems_that_occured}
